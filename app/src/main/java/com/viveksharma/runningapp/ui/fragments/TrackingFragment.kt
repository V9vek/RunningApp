...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mapView.onCreate(savedInstanceState)                                    //handling map view state
        ...
        mapView.getMapAsync {
            map = it
            addAllPolylines()               //On rotation fragment is recreated and getMapAsync is called
        }
    ...
    private fun addLatestPolyline() {
        if (pathPoints.isNotEmpty() && pathPoints.last().size > 1) {             //if there are more than 1 point to make a line
